...
public class StickyDictiAdapter extends BaseAdapter implements
    ...
    private ArrayList<String> mDataShow;
    ...
    public StickyDictiAdapter(Context context, ArrayList<String> arrayList,ArrayList<String> mDataShow) {
        mContext = context;
        this.mData = arrayList;
        this.mDataShow=mDataShow;
    ...
    public View getView(final int position, View convertView, final ViewGroup parent) {
        ...
        try {
            holder.text.setText(mDataShow.get(position));
        } catch (Exception e) {
            e.printStackTrace();
        }
