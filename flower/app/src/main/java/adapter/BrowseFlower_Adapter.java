 ...
 */
public class BrowseFlower_Adapter extends BaseAdapter {
    ...
    public BrowseFlower_Adapter(Context con, ArrayList<FlowerListDto> arr, ListView listView, ProgressBar pb) {
        this.pb = pb;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = (RelativeLayout) vi.inflate(R.layout.browserflower_row, parent, false);
...
//                    });
        ...
        listView.setOnScrollListener(new AbsListView.OnScrollListener() {
            ...
            public void onScroll(AbsListView view, int firstVisibleItem,
                ...
                if (arr != null && !arr.isEmpty() && arr.size() >= 10) {
